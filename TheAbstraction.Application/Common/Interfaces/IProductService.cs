...
namespace TheAbstraction.Application.Common.Interfaces
{
    ...
    {
        Task<int> CreateAsync(string name, string description, bool isActive, List<CreateProductVariantCommand> productVariants, CancellationToken cancellationToken = default);
        Task<int> UpdateAsync(string id, string name, string description, bool isActive, CancellationToken cancellationToken = default);
